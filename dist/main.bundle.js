...
var EventViewComponent = (function () {
    ...
    EventViewComponent.prototype.ngOnInit = function () {
        ...
        this.route.params
            ...
            _this.previousId = (Number(_this.id) + 1);
        });
        this.getEvents();
    };
...
module.exports = "<div class=\"jumbotron text-center\">\r\n  <h1>\r\n    {{title}}\r\n  </h1>\r\n</div>\r\n<nav class=\"navbar navbar-default navbar-fixed-top\">\r\n  <div class=\"container\">\r\n    <div class=\"navbar-header\">\r\n      <button type=\"button\" class=\"navbar-toggle\" data-toggle=\"collapse\" data-target=\"#myNavbar\">\r\n        <span class=\"icon-bar\"></span>\r\n        <span class=\"icon-bar\"></span>\r\n        <span class=\"icon-bar\"></span> \r\n      </button>\r\n    </div>\r\n    <div class=\"collapse navbar-collapse\" id=\"myNavbar\">\r\n      <ul class=\"nav navbar-nav navbar-\">\r\n        <li><a routerLink=\"/events\" routerLinkActive=\"active\">EVENTS</a></li>\r\n        <li><a [hidden]=\"tokenService.isLoggedIn()\" routerLink=\"/login\" routerLinkActive=\"active\">LOGIN</a></li>\r\n        <li><a routerLink=\"/register\" routerLinkActive=\"active\">REGISTER</a></li>\r\n        <li><a [hidden]=\"!tokenService.isLoggedIn()\" routerLink=\"/login\" routerLinkActive=\"active\" (click)=\"logout()\">LOGOUT</a></li>\r\n      </ul>\r\n    </div>\r\n  </div>\r\n</nav>\r\n<router-outlet></router-outlet>\r\n"
...
module.exports = "<div class=\"container\">\r\n    <h1 class=\"form-account-heading\">Events</h1>    \r\n    <table class=\"table table-hover table-bordered\">\r\n        <tr *ngFor=\"let entry of entries\">\r\n            <event-entry [entry]=\"entry\" [hidden]=\"entry.allAreInactive() && !isLoggedIn\"></event-entry>\r\n        </tr>\r\n    </table>\r\n    <div class=\"col-md-12 text-center\">\r\n        <a class=\"btn btn-lg btn-danger\" role=\"button\" href=\"/events/{{nextId}}\" routerLinkActive=\"active\" [hidden]=\"!isLoggedIn\"> < </a>\r\n        <a class=\"btn btn-lg btn-danger\" role=\"button\" href=\"/events/{{previousId}}\" routerLinkActive=\"active\" [hidden]=\"!isLoggedIn\"> > </a>\r\n    </div>\r\n</div>"
